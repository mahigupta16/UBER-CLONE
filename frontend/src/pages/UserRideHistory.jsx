        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white shadow-sm border-b">
                <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
                    ...
                    <img className="w-12 h-12 object-contain" src="https://upload.wikimedia.org/wikipedia/commons/c/cc/Uber_logo_2018.png" alt="Uber Logo" />
                </div>
            </div>
                                ...
                                {ride.captain && (
                                    <div className="mt-3 pt-3 border-t border-gray-100">
                                        <p className="text-sm text-gray-600">
                                            <span className="font-medium">Driver:</span> {ride.captain.fullname?.firstname} {ride.captain.fullname?.lastname}
                                        </p>
                                    </div>
                                )}
                            </div>
